...
object.m_healthData:pushIntMember( HealthComponentMaxHealth, 120 )
...
object.m_moveData:pushTickTypeMember( MoveComponentMovingSpeed, 8 )
...
object.m_attackData:pushIntMember( AttackComponentMinDamage, 16 )
object.m_attackData:pushIntMember( AttackComponentMaxDamage, 20 )
...
function TrollAxethrowerCreator( gameObject )

	gameObject:getObjectPtrMember( HealthComponentName ):pushIntMember( HealthComponentHealth, 120 )
...
StaticData:regObjectCreator( QString( "Troll Axethrower" ), QString( "TrollAxethrowerCreator" ) )
