...
do
	objectName = QString( "Footman" )
	objectAtlas = QString( "units/footman" )
...
SystemMessenger:printMessage(IMessenger.Info, QString("Footman's graphics info has been loaded."))